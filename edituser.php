                ...
                if ($id_user == $_SESSION['id_user']) {
                    ...
                    if (!preg_match("/^[2-3]*$/", $admin)) {
                        ...
                        if (isset($_REQUEST['password'])) {
                            ...
                            $query = mysqli_query($config, "UPDATE user SET admin='$admin' WHERE id_user='$id_user'");
                        }
                        if ($query == true) {
                ...
                if (mysqli_num_rows($query) > 0) {
                    ...
                    while ($row = mysqli_fetch_array($query)) { ?>
                            ...
                            <div class="col s12">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1">
                                        <ul class="left">
                                            <li class="waves-effect waves-light  tooltipped" data-position="right" data-tooltip="Menu ini hanya untuk mengedit level pengguna. Username dan password bisa diganti lewat menu profil"><a href="#" class="judul"><i class="material-icons">mode_edit</i> Edit Level Pengguna</a></li>
                                        </ul>
                                    </div>
                                </nav>
                            </div>
                        ...
                        <div class="row jarak-form">
                            ...
                            <!-- Form START -->
                            <form class="col s12" method="post" action="?page=kel&sub=usr&act=edit">
